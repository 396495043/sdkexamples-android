...
public class SettingActivity extends BaseActivity implements OnClickListener  {
    ...
    protected void onCreate(Bundle arg0) {
        super.onCreate(arg0);
        setContentView(R.layout.sky_settings);
		...
		((LinearLayout)findViewById(R.id.refreshAllContact)).setOnClickListener(this);		
	...
	public void onClick(View v) {
		...
		//SKYMODIFY		     
         case R.id.check_update:
           	 AndroidUtil.showToast(this, R.string.checkUpdateToast);
         ...
         case R.id.refreshAllContact:
        	 ...
        	 SkyUserManager.getInstances().setFirstRun(this);
        	 SettingsFragment.settingsFragment.logout();
	         break;	          
		default:
			break;
		}
