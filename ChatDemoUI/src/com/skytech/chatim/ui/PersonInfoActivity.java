...
public class PersonInfoActivity extends BaseActivity implements OnClickListener {
	...
	private String getShareText() {
		...
		sb.append(getShareTextString(R.string.nickName,R.id.et_input_nickname));
		sb.append(getShareTextString(R.string.email,R.id.et_input_email));
		sb.append(getShareTextString(R.string.org,R.id.et_input_org));
		sb.append(getShareTextString(R.string.group,R.id.et_input_group));
		sb.append(getShareTextString(R.string.phone,R.id.et_input_phone));
		sb.append(getShareTextString(R.string.workPhone,R.id.et_input_workPhone));
